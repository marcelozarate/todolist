...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('todolistapp_task', (
            ...
            ('completed_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
    ...
    models = {
        ...
        'todolistapp.task': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['todolistapp.Category']"}),
            'completed_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit_date': ('django.db.models.fields.DateTimeField', [], {}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "u'P'", 'max_length': '1'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        }
    }

    complete_apps = ['todolistapp']